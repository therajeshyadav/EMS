...
import EditEmployeeModal from "./EditEmployeeModal"; // new
...
const EmployeeManagement = () => {
  ...
  const handleToggleStatus = async (employee) => {
    ...
    try {
      const res = await EmployeesApi.updateAdmin(employee._id, {
  ...
  const handleUpdateEmployee = async (id, updatedData) => {
    try {
      const res = await EmployeesApi.updateAdmin(id, updatedData);
      setEmployees((prev) =>
